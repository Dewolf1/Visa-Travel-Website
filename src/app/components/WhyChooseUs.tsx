          ...
          {stats.map((s, idx) => (
            ...
            >
              ...
              <div className="text-5xl font-serif font-black text-gradient-gold mb-1">
                {useCounter(s.value, 2500, inView)}{s.suffix}
              </div>
        ...
        >
          ...
          <div className="relative p-10 md:p-14 grid md:grid-cols-5 gap-10 items-center">
            <div className="md:col-span-3 text-white">
              <h3 className="text-3xl md:text-4xl font-serif mb-5 drop-shadow text-white">
                Visit Our Premium Office
              </h3>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-white font-semibold">Mezzanine Floor, L-119, KG Marg</p>
                    <p className="text-blue-200/60 text-sm">Connaught Place, New Delhi 110001</p>
                  </div>
                </div>
            ...
            <div className="md:col-span-2 flex flex-col gap-3">
              <a
                href="#contact"
                className="w-full text-center bg-secondary text-primary font-bold px-8 py-4 rounded-xl hover:bg-[#E6D08B] transition-all shadow-[0_0_20px_rgba(201,168,76,0.3)] hover:shadow-[0_0_30px_rgba(201,168,76,0.5)] hover:-translate-y-0.5"
              >
                Book a Consultation
              </a>
              <a
                ...
                className="w-full text-center bg-[#25D366] text-white font-bold px-8 py-4 rounded-xl hover:bg-[#1ebe5d] transition-all shadow-lg hover:-translate-y-0.5"
              >
                WhatsApp Now
              </a>
            </div>
